...
# We used it in the LateGrey paper to estimate nucleotide diversity from Oxford nanopore sequencing data along a chromosome.
...
# "cat out.chr1.sample.mpileup | python WinNuclDivmPileup500kb.py > OUT_nucleotide_diversity.chr1.txt"


## COPYRIGHT 2024-onwards CARL-JOHAN RUBIN AND UPPSALA UNIVERSITY. INQUERIES: carl(dot)rubin(at)gmail.com
...
def NuclDivFrommPileup():
	...
	for line in fileinput.input():
		...
		# print str(line)+'\n',
# 		print str(sum2_A)+'\t'+str(sum2_C)+'\t'+str(sum2_G)+'\t'+str(sum2_T)+'\t'+str(sum2_REF)+'\n',
# 		
		if sumall>=10:
